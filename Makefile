...
CDEFS = $(ARCHDEF) -DUSE_EEPROM=1 -DUSE_ETHERNET=0 -DUSE_FIRMATA=0 -DUSE_LCD=1 -DUSE_LCD4884=0 -DUSE_ODB=0 -DUSE_SD=0 -DUSE_SERVO=0 -DUSE_SOFTSERIAL=0 -DUSE_SPI=1 -DUSE_STEPPER=0 -DUSE_TINYGPS=0 -DUSE_WIRE=0
...
# Burn the fuses
fuses:
	$(AVRDUDE) -F -p $(MCU) -C /etc/avrdude.conf -v -e -V -c usbasp -P usb -U lfuse:w:0xFF:m -U hfuse:w:0xD1:m -U efuse:w:0xCB:m -F
